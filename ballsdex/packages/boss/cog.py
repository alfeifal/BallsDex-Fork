...
# ATK, HP
MAXSTATS = [1000000,1000000] # Max stats a card is limited to (before buffs)
# ATK, HP
...
class Boss(commands.GroupCog):
    ...
    async def start(
        ...
        await interaction.channel.send((f"# <a:Crown:1331246693546594372> The boss battle has begun! {self.bot.get_emoji(ball.emoji_id)}\n-# HP: {self.bossHP}"),file=file,)
